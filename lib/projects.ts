...
export const projects: Project[] = [
  ...
  {
    slug: "talentiq",
    title: "TalentIQ — AI-Native Recruitment OS",
    shortTitle: "TalentIQ",
    problem:
      "Recruitment tools are either too simple or too expensive — SMEs need a full-stack hiring OS they can own.",
    solution:
      "Full-stack monorepo: Next.js 15 recruiter UI, identity service with RBAC, Supabase/Postgres, and AI-assisted candidate ranking.",
    category: "dev",
    status: "in-build",
    metrics: [
      { value: "Monorepo", label: "Turborepo" },
      { value: "RBAC", label: "auth system" },
      { value: "Next.js 15", label: "frontend" },
    ],
    stack: ["TypeScript", "Next.js", "Supabase", "Prisma", "PostgreSQL", "Turborepo"],
    githubUrl: "https://github.com/Ireolami/TalentIq",
    caseStudy: false,
  },
];
